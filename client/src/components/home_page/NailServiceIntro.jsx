    ...
    <div className="container">
      <div className="text-section">
        ...
        <p className="gratuity">
          <em>
            We have added a 3% automatic gratuity to all of our nail services, allowing you to easily show appreciation for our talented technicians. This gratuity is in addition to the price of the service, so you can relax without worrying about tipping. If you'd like to adjust the gratuity, please feel free to do so at the front desk.
          </em>
        </p>
      </div>
